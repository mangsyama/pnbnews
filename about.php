    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6 mb-4">
                <h2><b>Tentang Kampus</b></h2> <br>
                <p>Direktur Politeknik Negeri Bali</p>
                <h3><b>I Nyoman Abdi, SE., M.eCom</b></h3>
                <p class="text-justify">Puji syukur kehadapan Ida Sang Hyang Widi Wasa saya panjatkan, karena atas segala rahmat dan karuniaNya kami segenap sivitas akademika Politeknik Negeri Bali (PNB) dapat menunaikan kewajiban turut berkontribusi dalam meningkatkan peran PNB untuk mewujudkan visi dan misi sebagai Lembaga pendidikan Vokasi Terdepan yang menghasilkan lulusan yang Profesional yang memiliki daya saing Internasional pada Tahun 2025.</p>
                <img src="./img/direktur.png" alt="Director Image" class="img-fluid rounded-circle">
            </div>
            <div class="col-lg-6 mb-4">
                <h2><b>Visi</b></h2>
                <p class="text-justify">Menjadi Lembaga Pendidikan Tinggi Vokasi Terdepan Penghasil Lulusan Profesional Berdaya Saing Internasional Pada Tahun 2025</p>
                <h2><b>Misi</b></h2>
